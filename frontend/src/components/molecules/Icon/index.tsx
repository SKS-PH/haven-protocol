...
const ICONS = {
	lock: (props:JSX.IntrinsicElements['svg']) => (
	...
	subscribe: (props: JSX.IntrinsicElements['svg']) => (
		<svg {...props} viewBox="0 0 24 24" fill="none">
	...
	posts: (props: JSX.IntrinsicElements['svg']) => (
		<svg {...props} viewBox="0 0 24 24" fill="none">
	...
	time: (props: JSX.IntrinsicElements['svg']) => (
		<svg
			{...props}
			viewBox="0 0 24 24"
			fill="none"
...
export const Icon: Component<IconProps> = (props) => {
	...
	return (
		<Show
			when={Boolean(ICONS[localProps.name])}
		>
			<IconGraphic
				{...etcProps}
			/>
