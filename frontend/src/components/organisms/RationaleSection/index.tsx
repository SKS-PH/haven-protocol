		...
		<>
			<section id="what-is-haven">
				<div className="container md:max-w-screen-md mx-auto">
					<div className="px-4 lg:px-6 box-border py-16">
			...
			<section>
				<div className="container mx-auto">
					<div className="px-4 lg:px-6 box-border md:flex py-16">
						<div className="md:w-0 flex-auto"></div>
						<div className="md:w-0 flex-auto">
							<h3 className="font-light text-5xl">Anti-platform risk</h3>
							<p className="text-2xl">
								Hello. Well, Marty, I'm almost eighteen-years-old, it's not like I've never parked before.
							</p>
							<p>
			...
			<section>
				<div className="container mx-auto">
					<div className="px-4 lg:px-6 py-16 md:flex box-border">
						<div className="md:w-0 flex-auto"></div>
						<div className="md:w-0 flex-auto">
							<h3 className="font-light text-5xl">Customisation</h3>
							<p className="text-2xl">
								Hello. Well, Marty, I'm almost eighteen-years-old, it's not like I've never parked before.
							</p>
							<p>
			...
			<section>
				<div className="container mx-auto">
					<div className="px-4 lg:px-6 box-border md:flex py-16">
						<div className="md:w-0 flex-auto"></div>
						<div className="md:w-0 flex-auto">
							<h3 className="font-light text-5xl">Democratisation</h3>
							<p className="text-2xl">
								Hello. Well, Marty, I'm almost eighteen-years-old, it's not like I've never parked before.
							</p>
							<p>
